...
export default async function handler({ body }: NextApiRequest, res: NextApiResponse<CreateResponse>) {
    return new Promise<void>(async resolve => {
        ...
        pool.query('INSERT INTO polls (id, owner_id, choices, ends_at, title, description) VALUES ($1, $2, $3, $4, $5, $6)', [uuid, ownerId, JSON.stringify(choices), endsAt, title, description]).then(() => {
