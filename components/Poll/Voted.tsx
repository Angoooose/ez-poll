    ...
    return (
        <div className="bg-neutral-700 shadow-md rounded-md px-6 py-4 my-4 flex justify-between">
            <div className="flex flex-col justify-center items-center w-1/3">
                ...
                <div className={`w-full flex flex-col justify-center items-center text-center py-5 px-4 rounded-md shadow-sm bg-gradient-to-r ${optionColors[userChoice]}`}>{choices[userChoice].name}</div>
            </div>
